<template>
  <section class="form-topic-card">
    <section
      v-if="isNew"
      class="form-topic-card__form"
    >
      <section class="form-topic-card__form__header">
        <p class="form-topic-card__form__header__title">
          {{
            showSubTopics
    ...
    >
      <section class="form-topic-card__item__content">
        ...
        <section class="form-topic-card__item__content__container">
          <p class="form-topic-card__item__content__container__title">
            {{ topic.name }}
          </p>
          <p class="form-topic-card__item__content__container__description">
            {{ topic.context }}
          </p>
        </section>
      </section>
